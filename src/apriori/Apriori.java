...
class AprioriCalculation
{
    ...
    String configFile="lib/config.txt"; //configuration file
    String transaFile="lib/transa.txt"; //transaction file
    String outputFile="lib/apriori-output.txt";//output file
